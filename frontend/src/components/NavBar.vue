...
<template>
    ...
    <nav id="main-nav" class="back-to-top-trigger lg:fixed lg:top-0 lg:left-0 lg:right-0 lg:z-50 flex flex-wrap w-full lg:w-[38rem] px-5 mx-auto justify-between select-none bg-[#354076] lg:rounded-b-xl lg:justify-center">
        ...
        <button id="toggle-menu" class="block border-0 bg-transparent px-2 group select-none hover:no-underline duration-500 text-neutral-200 lg:hidden" type="button" data-twe-collapse-init data-twe-target="#navbarSupportedContent2" aria-controls="navbarSupportedContent2" aria-expanded="false" aria-label="Toggle navigation" @click="toggleHamburgerMenuAnimation();">
            <!-- Hamburger icon -->
            <!--
        ...
        <div class="!visible hidden item-center w-full lg:w-auto lg:!flex lg:flex-grow-0" id="navbarSupportedContent2" data-twe-collapse-item>
            ...
            <ul class="flex flex-col lg:flex-row text-xl text-neutral-100 [&>li]:ml-10 lg:[&>li]:ml-0 [&>li]:list-item [&>li]:self-start lg:[&>li]:self.center lg:[&>li]:my-[1.95rem] lg:[&>li]:py-0 lg:[&>li]:px-4">
                ...
                <li class="my-8 lg:border-e-2 lg:border-black">
                    <RouterLink to="/projects" class="hover:!text-lime-400 py-5 select-none" title="Have a look at my projects." aria-label="Have a look at my projects completed and in progress.">
                        Projects
                    </RouterLink>
                </li>
                <li class="mb-8">
